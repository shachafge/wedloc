...
<header class="col-12" id="upPage">
    <!-- Second navbar for sign in -->
     ...
     <!--title of the place-->
    <div id="titlePlace"><p>אופוריה</p></div>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="/photos/photos_euphoria/cover.jpg" alt="Image">
      </div>

      <div class="item">
        <img src="/photos/photos_euphoria/cover2.jpg" alt="Image">
      </div>

        <div class="item">
            <img src="/photos/photos_euphoria/cover3.jpg" alt="Image">
        </div>
    </div>
...
<div class="container text-center col-12">    
  <div class="row">
      ...
      <div class="well">
        ...
        $sql = "SELECT street, number, city FROM address WHERE idP=5";
        ...
        $sql2 = "SELECT email, phone, url FROM place WHERE idPlace=5";
        ...
        <div class="well">
       <p>אופוריה מזמינה אתכם להתרגש מחוויה חדשה בירושלים ולחגוג אירוע של פעם בחיים.
האירועים שלנו מבוססים על קונספט חדשני, אהבה ותשוקה גדולה לעיצוב ולחוויה גדולה מהחיים של האורחים והחוגגים. אופוריה מציעים לאורחיה אולם מרווח, בעל תשתית איכותית וטכנולוגית, המתאימה למגוון רחב של אירועים פרטיים ועסקיים עד 600 אורחים ומותאם לאירועי קיץ וחורף. 
צוות האולם מסייע בהפקת והקמת האירוע, כך שיוצא אירוע מקופד, מתוכנן, נעים וחוויתי. לאחרונה הותקנה באולם מערכת תאורה חדשה, המפיצה אור יקרות, ומאפשרת הארה מבוקרת של חלקים שונים באולם. כמו כן, הותקנה מערכת סאונד חדשה ומשוכללת, על מנת שהמוזיקה תושמע באופן הרמוני בכל פינה. עיצוב האולם תוכנן כך שישרה נעימות וכיף אצל אורחנו, כך שההצלחה מובטחת</p>
      </div>
       
    </div>
    <div class="col-sm-4">
        <div class="container2">
            <img src="/photos/photos_euphoria/canopy.jpg" class="img-responsive" style="width:99%; height:auto" alt="Image">
    ...
    <div class="col-sm-4">
        <div class="container2"> 
            <img src="/photos/photos_euphoria/dance.jpg" class="img-responsive" style="width:100%; height:auto" alt="Image">
            <div class="text-block">
                <h5>הרחבה</h5> 
            </div>
        </div>
      ...
      <div class="col-sm-4">
         <div class="container2"> 
            <img src="/photos/photos_euphoria/hall.jpg" class="img-responsive" style="width:100%; height:auto" alt="Image">
                <div class="text-block">
                    <h5>האולם</h5>
                </div>
            </div>
    ...
    <div class="col-sm-4">
        <div class="container2"> 
            <img src="/photos/photos_euphoria/garden.jpg" class="img-responsive" style="width:100%; height:auto" alt="Image">
                <div class="text-block">
                    <h5>הגן</h5> 
                </div>
        </div>
...
<div class="slideshow-container col-12">
    ...
    <div class="mySlides">
    <p>החוויה שלנו היתה מהממת, האוכל המקום והאוירה היו מושלמים. היו כמה פאשלות אבל עדיין ממליצה</p>
        <p class="author">- ספיר רחמים -</p>
    </div>

    <div class="mySlides">
    <p>אוכל לא הוגש לפי משהוזמן.מלצריות לא מבצעות את עבודתם לפי הצפוי. העיצוב של המקום יפה אבל לא שווה את המחיר
</p>
        <p class="author">- קורל סימנוביץ -</p>
    </div>

    <div class="mySlides">
        <p>אני רוצה להמליץ על לירון הדיזי
        לירון העיף אותנו באוויר! אווירה מחשמלת באירוע שלנו היה קהל ישראלי לטיני וספרדי ולירון הצליח לקרב את כולם לתוך רחבה אחת ולגרום לכולם לרקוד לכול סוגי המוזיקה עוד  </p>
        <p class="author">- לירון באום -</p>
    </div>
