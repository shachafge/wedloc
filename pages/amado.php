...
<header class="col-12" id="upPage">
    <!-- Second navbar for sign in -->
      ...
      <div class="container">
        ...
        <!--title of the place-->
    <div id="titlePlace"><p>אמדו</p></div>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="/photos/photos_amado/cover.jpg" alt="Image">
      </div>

      <div class="item">
        <img src="/photos/photos_amado/cover2.jpg" alt="Image">
      </div>
      
      <div class="item">
        <img src="/photos/photos_amado/cover3.jpg" alt="Image">
      </div>
    </div>
...
<div class="container text-center col-12">    
  <div class="row">
      ...
      <div class="well">
        ...
        $sql = "SELECT street, number, city FROM address WHERE idP=11";
        ...
        $sql2 = "SELECT email, phone, url FROM place WHERE idPlace=11";
      ...
      <div class="well">
      <p>ממוקם בין השרון למרכז הארץ תפגשו את מיטב החידושים בתחום האירועים במרכז הארץ, לרבות תקרות גבוהות עם אקוסטיקה מושלמת, תאורה מרשימה, מקרנים ענקיים ומסך לדים. האוכל הוא עוד הפתעה נעימה שכן המטבח העילי שלנו עונה לכל דרישה, לכל בקשה ולכל צורך שתעלו בפני השף המוכשר שלנו. חשוב לציין כי לגן האירועים יש רשיון עסק בתוקף</p>
      </div>
       
    </div>
    <div class="col-sm-4">
        <div class="container2">
        <img src="/photos/photos_amado/canopy.jpg" class="img-responsive" style="width:100%; height:60%" alt="Image">
    ...
    <div class="col-sm-4">
        <div class="container2"> 
            <img src="/photos/photos_amado/garden.jpg" class="img-responsive" style="width:100%; height:60%" alt="Image">
                <div class="text-block">
                    <h5>הגן</h5>
                </div>
            </div>
      ...
      <div class="col-sm-4"> 
        <div class="container2">
            <img src="/photos/photos_amado/dance.jpg" class="img-responsive" style="width:100%; height:60%" alt="Image">
                <div class="text-block">
                    <h5>הרחבה</h5> 
                </div>
            </div>
    ...
    <div class="col-sm-4"> 
        <div class="container2">
            <img src="/photos/photos_amado/hall.jpg" class="img-responsive" style="width:100%; height:60%" alt="Image">
            <div class="text-block">
                <h5>האולם</h5>
            </div>
        </div>
...
<div class="slideshow-container col-12">
    ...
    <div class="mySlides">
    <p>כל ההתנהלות הייתה פשוטה נעימה. החל מספיר שדאגה לנו בטעימות שנהיה מרוצים, מורן שהייתה איתנו בקשר כל הזמן לראות שהכל בסדר ואופיר מנהל האירועים התותח שכל הערב רק דאג לנו ולאורחים שלנו בצורת מדהימה</p>
    <p class="author">- הילה טביב -</p>
    </div>

    <div class="mySlides">
        <p>מהרגע הראשון שנכנסנו לאולם ידענו שזה האולם שלנו!! זה היה האולם הראשון שראינו וגם האחרון. פשוט התאהבנו במקום!!! השירות היה מושלם לאורך כל הדרך והאנשים שעובדים המקום הזה עושים אותו לעוד יותר מושלם</p>
        <p class="author">- אלה רחמני -</p>
    </div>

    <div class="mySlides">
        <p>החתונה היתה רק לפני כמה ימים ואנחנו לא מפסיקים לקבל מחמאות, המיקום הכי טוב שיש, היופי של המקום שהוא פשוט בלתי נתפס, שום אולם לא דומה לו!! האוכל המדהים שכולם נהנו ממנו !! אורחים שלנו אמרו שירצו להתחתן שם בעתיד ואין מחמאה גדולה מזאת</p>
        <p class="author">- מיכל ראובני  -</p>
    </div>
