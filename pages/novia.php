...
<body>
    ...
    <!--title of the place-->
    <div id="titlePlace"><p>נוביה</p></div>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="/photos/photos_novia/cover.jpg" alt="Image">
      </div>

      <div class="item">
        <img src="/photos/photos_novia/cover2.jpg" alt="Image">
      </div>
    </div>
    ...
    <div class="container text-center col-12">    
     <div class="row">
      ...
      <div class="well">
        ...
        $sql = "SELECT street, number, city FROM address WHERE idP=6";
        ...
        $sql2 = "SELECT email, phone, url FROM place WHERE idPlace=6";
      ...
      <div class="well">
       <p>בנוביה אירועי יוקרה תתפלאו לראות איך עיצוב משתלב עם היופי הטבעי של האולם. לא משנה באיזה אולם משלושת האולמות תבחרו לחגוג את האירוע שלכם, כי אחד יפה יותר מהשני. 
העיצוב שהושקע באולמות מאפשר לעצב את כל אולם ולתת לו נגיעות אישיות לפי האופי והרצון של הלקוחות שלנו. 
אתם אלו שקובעים איך האירוע שלכם יראה</p>
      </div>
       
    </div>
    <div class="col-sm-4">
        <div class="container2">
            <img src="/photos/photos_novia/canopy.jpg" class="img-responsive" style="width:99%; height:auto" alt="Image">
    ...
    <div class="col-sm-4"> 
        <div class="container2">
            <img src="/photos/photos_novia/kitchen.jpg" class="img-responsive" style="width:100%; height:auto" alt="Image">
                <div class="text-block">
                    <h5>האוכל</h5>
                </div>
            </div>
      ...
      <div class="col-sm-4">
          <div class="container2"> 
            <img src="/photos/photos_novia/dance.jpg" class="img-responsive" style="width:100%; height:auto" alt="Image">
                <div class="text-block">
                    <h5>הרחבה</h5>
                </div>
            </div>
    ...
    <div class="col-sm-4">
        <div class="container2"> 
            <img src="/photos/photos_novia/hall.jpg" class="img-responsive" style="width:100%; height:auto" alt="Image">
                <div class="text-block">
                    <h5>האולם</h5>
                </div>
            </div>
...
<div class="slideshow-container col-12">
    ...
    <div class="mySlides">
    <p>עברנו מספר לא קטן של אולמות אירועים ולא מצאנו עצמנו שם.. עד.. שהגענו לנוביה. ראשית, נכנסנו לאולם מרהיב ביופיו, חדש, נקי ונוצץ! אבל זו לא גולת הכותרת שם. מייק כן. מייק הוא אחד האנשים הנדירים והמדהימים שיצא לנו להכיר בתעשיית האירועים. הרגשנו אצלו כמו בני משפחה.. קיבלנו שירות לא פחות ממושלם!! מייק היה קשוב לכל בקשה, שאלה או חשש, בכל שעה ובכל רגע נתון והכל בנועם ובדרכו המיוחדת. תוסיפו ליחס מדהים כזה את איגור השף, וקיבלתם צוות מנצח! שף אלוף, מקצועי וקשוב שמוציא מידיו מטעמים ברמה גבוהה, והאירוע שלנו היה טבעוני, שזו משימה לא הכי פשוטה בימנו, אך איגור הצליח לספק לנו אוכל ברמה גבוהה וטעימה! תודה לכל הצוות המדהים בנוביה, אתם נדירים ולא נשכח אתכם!
</p>
    <p class="author">- עדי אברהמי -</p>
    </div>

    <div class="mySlides">
        <p> תודה רבה לכם על הכל ! החל מהשירות המצויין שקיבלנו טרם האירוע. כל בקשה שבקשנו וכל דבר שרצינו נענתם לו על הצד הטוב ביותר. כמובן במהלך האירוע על השירות המדהים על האוכל מעולה ברמה הכי גבוהה שיש וכמובן על פתירת כל הבעיות במהלך האירוע שצצו בלי שבכלל נדע מהם. ישר הכל טופל ונפתר על המקום- ובזה אנחנו רוצים להגיד תודה מיוחדת לנאור ולחלומה! תודה תודה תודה הייתם מדהימים ומקצועיים בטירוף! אוהבים אותכם וממליצים הכי בחום שבעולם! תודה! תודה! תודה </p>
        <p class="author">- רעות ברזילי -</p>
    </div>

    <div class="mySlides">
        <p>
חתונה טבעונית בנוביה..מה אפשר להגיד חוץ מ - אני כל כך שמחה שבחרנו בכם! התחתנתי בנוביה ב22.2.18, חיפשנו אולם שיציע לנו תפריט טבעוני, עשיר ומגוון, ל-300 אורחים. בנוביה עשו את זה בצורה מושלמת - השף הרכיב מנות מדהימות, הבופה היה עשיר ומלא באוכל. התגובות היו כל כך אוהדות וקיבלנו כל כך הרבה פרגונים - רק בזכותכם! ובכלל - הליווי של הצוות מהרגע שנכנסו לאולם לחתום על חוזה ועד הסוף היה מעולה, תודעת שירות גבוהה ויחס אישי ואוהב   תודה ענקית למשה, מייק, איגור השף, חלומה.. היה לנו ערב מהחלומות </p>
        <p class="author">- שרי יצחקי -</p>
    </div>
