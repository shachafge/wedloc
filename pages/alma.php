...
<header class="col-12" id="upPage">
    ...
    <!--title of the place-->
    <div id="titlePlace"><p>עלמה</p></div>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="/photos/photos_alma/cover.jpg" alt="Image">
      </div>

      <div class="item">
        <img src="/photos/photos_alma/cover2.jpg" alt="Image">
      </div>
...
<div class="container text-center col-12">    
  <div class="row">
      ...
      <div class="well">
        ...
        $sql = "SELECT street, number, city FROM address WHERE idP=1";
        ...
        $sql2 = "SELECT email, phone, url FROM place WHERE idPlace=1";
      ...
      <div class="well">
      <p> בית לאירועים חדשני ויוקרתי בסגנון מודרני-קלאסי תוכנן עם מחשבה עמוקה המקיפה את הפרטים הגדולים והקטנים כאחד. מתאר המקום בנוי קווים נקיים מאפשר במה מתאימה להדגשת הגוון הייחודי של כל אירוע. 
האבזור והסטיילינג המשלים, העשוי חומרים עשירים וטבעיים, יוצרים אוירה חגיגית במיוחד לצד מגע מסוגנן ואיכותי של אינטימיות.

החלל הפנימי מתאים לאירוח של עד 700 אורחים בישיבה סביב שולחנות, אך יכול להתאים בקלות רבה גם לאירוע של 200 מוזמנים או למסיבה של 1000 איש. כל הפרטים הותאמו כדי לתת חווית אירוח מושלמת </p>
      </div>
       
    </div>
    <div class="col-sm-4">
        <div class="container2">
        <img src="/photos/photos_alma/canopy.jpg" class="img-responsive" style="width:100%; height:auto" alt="Image">
    ...
    <div class="col-sm-4">
        <div class="container2"> 
            <img src="/photos/photos_alma/garden.jpg" class="img-responsive" style="width:100%; height:auto" alt="Image">
                <div class="text-block">
                    <h5>הגן</h5>
                </div>
            </div>
      ...
      <div class="col-sm-4"> 
        <div class="container2">
            <img src="/photos/photos_alma/dance.jpg" class="img-responsive" style="width:100%; height:auto" alt="Image">
                <div class="text-block">
                    <h5>הרחבה</h5> 
                </div>
            </div>
    ...
    <div class="col-sm-4"> 
        <div class="container2">
            <img src="/photos/photos_alma/hall.jpg" class="img-responsive" style="width:100%; height:auto" alt="Image">
            <div class="text-block">
                <h5>האולם</h5>
            </div>
        </div>
...
<div class="slideshow-container col-12">
    ...
    <div class="mySlides">
    <p>ראיתי את תמונות מהאולם בפייסבוק של חברה אחרת ובאותו רגע התאהבתי! ידעתי ששם אני אתחתן כשיגיע הרגע וזה מה שהיה. ראינו עוד אולמות בשביל השוואה כללית, אבל כשהגענו לעלמה לפגישה עם נמרוד המהמם הבנו שזהו, זה האולם שלנו. האולם יפהפייה ומבין האולמות שראינו הוא גם נתן את המחיר הכי טוב עבור התמורה. וכמובן הייחודיות שלו עם בריכה ההשתקפות והקיר הקרנה הענק</p>
    <p class="author">- לירון הלוי -</p>
    </div>

    <div class="mySlides">
        <p>הגענו לאולם עלמה לאחר שראינו הרבה אולמות והרגשנו שזה האולם שבו נתחתן ! המקום מדהים, הירק מסביב,הפרחים, הגן עצמו מטופח מאוד, השביל על המים - משגע !!!! הכרנו את אנשי המכירות, מלצרים,ברמנים, מנכ''ל האולם , מנהל המטבח, מנהל אירועים- כולם מקצוענים ומקסימים ! היו לנו דרישות גבוהות, תיאום ציפיות בהחלט היה תואם, האולם השקיע מאוד ! הכל היה בדיוק כפי שסוכ</p>
        <p class="author">- דנה ראובני -</p>
    </div>

    <div class="mySlides">
        <p>מאחלים לכל זוג שמחפש את האולם המושלם בשבילו להתחתן בעלמה. כי זאת תהיה חתונה שלא יפסיקו לדבר עליה! פשוט חלום! תודה לכל הצוות המדהים על חוויה בלתי נשכחת </p>
        <p class="author">- גאיה פלט -</p>
    </div>
