...
<header class="col-12" id="upPage">
    <!-- Second navbar for sign in -->
     ...
     <!--title of the place-->
    <div id="titlePlace"><p>ביער</p></div>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="/photos/photos_bayaar/cover.jpg" alt="Image">
      </div>

      <div class="item">
        <img src="/photos/photos_bayaar/cover2.jpg" alt="Image">
      </div>
      
      <div class="item">
        <img src="/photos/photos_bayaar/cover3.jpg" alt="Image">
      </div>
    </div>
...
<div class="container text-center col-12">    
  <div class="row">
      ...
      <div class="well">
       <p>
בלב פארק השרון – אחת משמורות הטבע האחרונות והיפות ביותר במישור החוף, בחרנו להקים את "ביער" – אתר אירועים ייחודי ומוקפד, היוצר רצף אינטגראלי עם הסביבה המקיפה אותו. מתחם טבעי המהווה שמורת טבע בפני עצמה. שמורת טבע של איכות.

הטבע עצמו אחראי לעיצוב המיוחד של "ביער". לנו נותר רק לבחור באנשי המקצוע הטובים ביותר שישכילו "לעבוד איתו". החזון שלנו היה להקים אתר אירוח בטבע, המשרה אווירה אינטימית. מתחם המעוצב בקפידה עד הפרט האחרון למגוון רחב של אירועים, המאפשר לכם לתכנן חוויה חד-פעמית, ייחודית ומרגשת. יחד עם זאת, חשוב היה לנו לשמור על סביבתו הטבעית ויופיו האותנטי של פארק השרון – מבלי להתערב בו או לקלקל אותו</p>
      </div>
       
    </div>
    <div class="col-sm-4">
        <div class="container2">
            <img src="/photos/photos_bayaar/canopy.jpg" class="img-responsive" style="width:99%; height:60%" alt="Image">
    ...
    <div class="col-sm-4">
        <div class="container2"> 
            <img src="/photos/photos_bayaar/garden.jpg" class="img-responsive" style="width:100%; height:60%" alt="Image">
                <div class="text-block">
                <h5>הגן</h5>
                </div>
            </div>
      ...
      <div class="col-sm-4">
          <div class="container2"> 
            <img src="/photos/photos_bayaar/dance.jpg" class="img-responsive" style="width:100%; height:60%" alt="Image">
                <div class="text-block">
                <h5>הרחבה</h5> 
                </div>
        </div>
    ...
    <div class="col-sm-4">
        <div class="container2"> 
            <img src="/photos/photos_bayaar/hall.jpg" class="img-responsive" style="width:100%; height:60%" alt="Image">
            <div class="text-block">
                <h5>האולם</h5>
            </div>
        </div>
...
<div class="slideshow-container col-12">
    ...
    <div class="mySlides">
    <p>היה ארוע מדהים! לאורך כל התהליך הייתה זמינות מלאה של מנהלי הגן והצוות כולו</p>
    <p class="author">- אריאל גליקסברג -</p>
    </div>

    <div class="mySlides">
        <p> השירות היה נהדר! המקום היה קשוב לצרכים שלנו ובא לקראתנו. עזרו לנו בכל דברף מקטן ועד גדול מתחילת ההתקשרות ועד סוף האירוע. תודה רבה </p>
        <p class="author">- רונית חי -</p>
    </div>

    <div class="mySlides">
        <p>ואוו, קשה לי לתאר במילים כמה מושלם המקום והצוות, האווירה הייתה מושלמת והיחס בלי רגיל. כתבו פה רבות על המקום ואני מרגישה שקטונטי מלהוסיף</p>
        <p class="author">- נעמי פנחסי -</p>
    </div>
