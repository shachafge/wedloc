...
<header class="col-12" id="upPage">
    ...
    <!--title of the place-->
    <div id="titlePlace"><p>אבניו</p></div>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="/photos/photos_avenue/cover.jpg" alt="Image">
      </div>

      <div class="item">
        <img src="/photos/photos_avenue/cover2.jpg" alt="Image">
      </div>

        <div class="item">
            <img src="/photos/photos_avenue//cover3.jpg" alt="Image">
        </div>
    </div>
...
<div class="container text-center col-12">    
  <div class="row">
      ...
      <div class="well">
        ...
        $sql = "SELECT street, number, city FROM address WHERE idP=4";
        ...
        $sql2 = "SELECT email, phone, url FROM place WHERE idPlace=4";
      ...
      <div class="well">
       <p>במבנה אקלקטי והייחודי ביותר בישראל, תמצאו כל מה שצריך כדי להגשים כל חלום: מיקום מרכזי ונגיש במרכז הארץ, חנייה בשפע, גנים מטופחים ויפהפיים, אולמות אירועים מעוצבים וקלאסיים, מטבח שף מקומי מעולה וטכנולוגיית אודיו ויז'ואל מהמתקדמות בעולם – ההופכת כל אירוע לחוויה קסומה בעלת אופי ייחודי

 אווניו הוקם בשנת 2006, והינו עסק משפחתי המשלב שני דורות עם ותק וניסיון של למעלה מ-20 שנה

 אנו מנהלים ומפעילים את המקום מכל הלב, מעניקים שירות ויחס אישי ואכפתי וזמינים עבורכם לכל שאלה או התייעצות

הצוות עתיר הניסיון שלנו ילווה אתכם עם רעיונות יצירתיים, טיפים חשובים ופתרונות מהירים כדי שהאירוע שלכם יהיה מושלם, בדיוק כפי שתכננתם</p>
      </div>
       
    </div>
    <div class="col-sm-4">
        <div class="container2">
      <img src="/photos/photos_avenue/canopy.jpg" class="img-responsive" style="width:100%" alt="Image">
    ...
    <div class="col-sm-4">
        <div class="container2"> 
            <img src="/photos/photos_avenue/garden.jpg" class="img-responsive" style="width:100%" alt="Image">
            <div class="text-block">
                <h5>הגן</h5>
            </div>
        </div>
      ...
      <div class="col-sm-4">
          <div class="container2"> 
            <img src="/photos/photos_avenue/kitchen.jpg" class="img-responsive" style="width:100%" alt="Image">
                <div class="text-block">
                    <h5>המטבח</h5> 
            </div>
        </div>
    ...
    <div class="col-sm-4">
        <div class="container2"> 
            <img src="/photos/photos_avenue/hall.jpg" class="img-responsive" style="width:100%" alt="Image">
            <div class="text-block">
                <h5>האולם</h5> 
            </div>
        </div>
...
<div class="slideshow-container col-12">
    ...
    <div class="mySlides">
        <p>מהרגע הראשון נתקלנו ביחס חם מפנק ומקצועי, מיקי היה מעל ומעבר לא היה דבר ולו הכי קטן שלא קיבלנו מענה תמיד בכל שעה, הייתי כלה סופר פדנטית הכל היה חשוב ליום הגדול ובאבניו בהחלט יודעים לתת מענה על כך! היה אירוע חלומי לא מפסיקים לקבל עליו מחמאות על העיצוב על האוכל על השירות! רמה גבוהה בהחלט שווה כל שקל כשמשקיעים באירוע של פעם בחיים! מומלץ בחוםםםםםם
</p>
        <p class="author">- נסטיה לדרמן -</p>
    </div>

    <div class="mySlides">
        <p>לפני כשבוע התחתנו באווניו וברשותכם אתחיל מהמפגש הראשון שלנו עם המקום. לאחר חיפוש מקיף של מקום לחגוג בו את היום החשוב בחיינו ביקרנו במספר לא מבוטל של אולמות אירועים. כאשר הגענו לאווניו קיבלו את פנינו צוות המקום בסבר פנים יפות ובחיוך. מהרגע הזה נשבנו מאחר והמקום מדהים ביופיו והצוות המקצועי אשר ליווה אותנו לאורך כל התהליך גילה סבלנות אינסופית בכל יום ושעה בהם פנינו אליהם </p>
        <p class="author">- מיכל יצחקי -</p>
    </div>

    <div class="mySlides">
        <p>אנחנו מאושרים שבחרנו באווניו!! אולם מהמם, אוכל הכי טוב שאכלנו אי פעם באולמות אירועים (ברמה של מסעדת שף), וצוות מדהים!! מהתחלה ועד הסוף קיבלנו יחס אדיב וחם. שיר מהמכירות, אבי המנהל של המקום, נס מנהל הבר, מיקי המעצב המדהים וטוני האחד והיחיד שגם בחג שהוא היה בבית נתן לנו מענה מהיר ומקצועי. מנהל האירוע - חיים, כל כך מקצועי, דואג להכל עוד לפני שחשבת לבקש משהו זה כבר בוצע, הוא נתן לנו את הרגשה הכי נוחה שיכולה להיות</p>
        <p class="author">- אלה פפר -</p>
    </div>
