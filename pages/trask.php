...
<body>
    ...
    <!--title of the place-->
    <div id="titlePlace"><p>טראסק</p></div>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="/photos/photos_trask//cover.jpg" alt="Image">
      </div>

      <div class="item">
        <img src="/photos/photos_trask//cover2.jpg" alt="Image">
      </div>

        <div class="item">
            <img src="/photos/photos_trask//cover3.jpg" alt="Image">
        </div>
    </div>
...
<div class="container text-center col-12">    
  <div class="row">
      ...
      <div class="well">
        ...
        $sql = "SELECT street, number, city FROM address WHERE idP=3";
        ...
        $sql2 = "SELECT email, phone, url FROM place WHERE idPlace=3";
      ...
      <div class="well">
       <p>טראסק הינו מבנה של 1200 ממ"ר עם גובה תקרה של 6 מטר מצויד במערכות תאורה, הגברה, הקרנה ומיזוג מהחדישות והמתקדמות שיש. החלל והדק שעל גג המבנה מספקים מיקום ואוירה ייחודית שמשנה את עצמה בכל פעם מחדש בהתאם לסוג האירוע ורצון לקוחותיו. במקום ניתן לקיים חתונות ואירועים עיסקיים של עד 900 מוזמנים סביב שולחנות ואירועי קוקטייל של עד 1900 מוזמנים.</p>
      </div>
       
    </div>
    <div class="col-sm-4">
        <div class="container2">
            <img src="/photos/photos_trask/canopy.jpg" class="img-responsive" style="width:100%" alt="Image">
    ...
    <div class="col-sm-4">
        <div class="container2"> 
            <img src="/photos/photos_trask/garden.jpg" class="img-responsive" style="width:100%" alt="Image">
                <div class="text-block"> 
                    <h5>הבחוץ</h5>
                </div>
            </div>
      ...
      <div class="col-sm-4">
          <div class="container2"> 
            <img src="/photos/photos_trask/dance.jpg" class="img-responsive" style="width:100%" alt="Image">
                <div class="text-block"> 
                    <h5>הרחבה</h5>
                </div>
        </div>
    ...
    <div class="col-sm-4">
        <div class="container2"> 
            <img src="/photos/photos_trask/hall.jpg" class="img-responsive" style="width:100%" alt="Image">
                <div class="text-block"> 
                    <h5>האולם</h5>
                </div>
            </div>
...
<div class="slideshow-container col-12">
    ...
    <div class="mySlides">
        <p>מקום מושלם לאירועים! לוקיישן מנצח וצוות מקצועי ואדיב מאוד! הכל התנהל כפי שרצינו, חייבת לציין לטובה את נטלי שליוותה אותנו עד ליום האירוע ועשתה זאת במקוצעיות מקסימלית ובשירותיות גם אפי מנהל המקום היה סופר מקצועי ואדיב והוריד מאיתנו המון לחץ ודאגות גם לפני האירוע וגם ביום האירוע.</p>
        <p class="author">- סתיו ירקוני -</p>
    </div>

    <div class="mySlides">
        <p>האירוע והעבודה לאורך הדרך עם הטראסק היה מדהים. אפי מנהל האירוע ניהל את האירוע בצורה מדהימה, עזר בכל דבר שהיינו צריכים והרבה מעבר למה שציפינו ולהגדרת התפקיד שלו - בלעדיו האירוע לא היה אותו דבר! </p>
        <p class="author">- מור שרעבני -</p>
    </div>

    <div class="mySlides">
        <p>הקייטרינג זה משהו שאתם חייבים לשמור קרוב מאוד אליכם. זה לא קורה הרבה שאנשים מגיעים לחתונה ומרגישים במסעדת יוקרה. באירוע שלי היו אנשים מובילים מתעשיית הפרסום הישראלי. מנכל״לים, בעלים ועוד. אנשים שהסטנדרט שלהם גבוה מאוד בכל הנוגע לאוכל. מיקל נתן הופעה שלא תישכח. אין בן אדם שאני מדבר איתו ולא מחמיא על האוכל ועל היצירתיות והטעם. בטראסק עצמו יש אווירה מדהימה והצוות מהמם. דואג ואכפתי. אפי גבר ואכפת לו. עושה הכל עם חיוך ודואג שיהיה לך טוב.</p>
        <p class="author">- אלירן לוי -</p>
    </div>
