...
<body>
    ...
    <!--title of the place-->
    <div id="titlePlace"><p>גן ורדים</p></div>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="/photos/photos_gv//cover.jpg" alt="Image">
      </div>

      <div class="item">
        <img src="/photos/photos_gv//cover2.jpg" alt="Image">
      </div>

        <div class="item">
            <img src="/photos/photos_gv//gan2.jpg" alt="Image">
        </div>
    </div>
...
<div class="container text-center col-12">    
  <div class="row">
      ...
      <div class="well">
        ...
        $sql = "SELECT street, number, city FROM address WHERE idP=2";
        ...
        $sql2 = "SELECT email, phone, url FROM place WHERE idPlace=2";
      ...
      <div class="well">
       <p>גן קסום לחתונות המשלב בין הטבעי לאורבני, המשתרע על פני 12 דונם של צמחייה מרהיבה ובאווירה פסטורלית ייחודית. מתחם אירוח מושקע וברמה הגבוהה ביותר הכולל בר אלכוהול משובח, מטבח שף ואפשרויות עיצוב ייחודיות בהתאם לרצון הזוג, כל אלו הנם החותם לאווירה מושלמת ולאירוע מוצלח </p>
        <p> הגן מתאים לאירועי חורף וקיץ, בין אם תחת כיפת השמיים במראה טבע ונינוח או באולם סגור מוקפד ומעוצב להפליא, מאובזר במערכות המתקדמות ביותר</p>
      </div>
       
    </div>
    <div class="col-sm-4">
        <div class="container2"> 
            <img src="/photos/photos_gv/canopy.jpg" class="img-responsive" style="width:100%" alt="Image">
    ...
    <div class="col-sm-4">
        <div class="container2">  
            <img src="/photos/photos_gv/garden.jpg" class="img-responsive" style="width:100%" alt="Image">
                <div class="text-block">
                    <h5>הגן</h5>  
                </div>
            </div>
      ...
      <div class="col-sm-4">
          <div class="container2">  
            <img src="/photos/photos_gv/dance.jpg" class="img-responsive" style="width:100%" alt="Image">
                <div class="text-block">
                    <h5>הרחבה</h5>
                </div>
        </div>
    ...
    <div class="col-sm-4">
        <div class="container2">  
            <img src="/photos/photos_gv/hall.jpg" class="img-responsive" style="width:100%" alt="Image">
                <div class="text-block">
                    <h5>האולם</h5>    
                </div>
            </div>
...
<div class="slideshow-container col-12">
    ...
    <div class="mySlides">
        <p>מהרגע שהגענו לגן ורדים התאהבנו במקום ובצוות! קיבלנו יחס מדהים ומענה מהיר בכל שאלה שהייתה לנו. ירדן מנהלת המכירות שלנו ליוותה אותנו לכל אורך הדרך ונתנה לנו יחס אישי וחם! תמיד עם חיוך,
            רצון לעזור ועם אנרגיות חיוביות! ניהול האירוע היה בצורה מושלמת בדיוק כפי שדמיינו, כשבראש עמד טל, מנהל האירוע, שנענה לכל בקשה בחיוב והפך הכל לפשוט וקל יותר. חשוב מאוד לציין שכל ההתנהלות נעשתה בחיוך ובאהבה גדולה , חושבים מהפרט הקטן ביותר עד לגדול ביותר </p>
        <p class="author">- מורן אדר -</p>
    </div>

    <div class="mySlides">
        <p>הכי מאושרים בעולם שהתחנתנו שם! מקום מדהים, אוכל מדהים והכי חשוב אנשים מדהימים! אנחנו אחד מהזוגות שנפגעו מאיזיווד
            והגן בא לקראתנו! כל הצוות שם מדהים. יוסי ודניאל מהמשרדים וטל מנהל האירוע היו מצויינים ועשו לנו אחלה של ארוע! ממליץ בחום </p>
        <p class="author">- קובי גרטל -</p>
    </div>

    <div class="mySlides">
        <p>התחתנו ב-7.4.19, קבלת פנים וחופה היו בחוץ, והאירוע עצמו באולם. המקום מדהים ביופיו! החופה כאילו נפלה מגן עדן.
            כל פעם שנכנסתי נדהמתי איך בגן כזה ענק כל פינה (!) מושקעת עד לפרטים הקטנים. הגן סוחף את העיניים. יש שם קסם, ולא כקלישאה, באמת. האולם בנוי מעולה- הבר על הרחבה, נוח, אינטימי, חמים, עם חלונות שמשקיפים לגן המדהים. האוכל מעולה. לגמרי הייתי מתחתנת שם שוב</p>
        <p class="author">- עמית בס -</p>
    </div>
