...
<header class="col-12" id="upPage">
    ...
    <!--title of the place-->
    <div id="titlePlace"><p>בת הגלבוע</p></div>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="/photos/photos_batHagil/cover.jpg" alt="Image">
      </div>

      <div class="item">
        <img src="/photos/photos_batHagil/cover2.jpg" alt="Image">
      </div>
      
      <div class="item">
        <img src="/photos/photos_batHagil/cover3.jpg" alt="Image">
      </div>
    </div>
...
<div class="container text-center col-12">    
  <div class="row">
      ...
      <div class="well">
        ...
        $sql = "SELECT street, number, city FROM address WHERE idP=12";
        ...
        $sql2 = "SELECT email, phone, url FROM place WHERE idPlace=12";
      ...
      <div class="well">
          <p>לוקיישן נגיש ונוח- הגן נמצא על כביש עפולה-עין חרוד, מתחת לקבוצת גבע (כ-7 דקות נסיעה מעפולה) לנוחותם של המוזמנים. 
וזאת מבלי לוותר על מרחבים פתוחים- שבזכותם ניתן לקיים בגן חתונה בת כ-750 אורחים מצד אחד, ולא מוותרת על תחושת האינטימיות מצד שני.
הגן רחב הידיים מאפשר לזוגות לבחור להם את הנקודה הרומנטית ביותר לקיום טקס החופה, ובמיוחד כשמדובר בחגיגת חתונה בקיץ בצפון, כיפת השמים לעת ערב מתמזגת עם צבעי הגן והתאורה המיוחדת הבוקעת ממנו לכדי רגעים בלתי נשכחים</p>
      </div>
       
    </div>
    <div class="col-sm-4">
        <div class="container2">
            <img src="/photos/photos_batHagil/canopy.jpg" class="img-responsive" style="width:100%; height:60%" alt="Image">
    ...
    <div class="col-sm-4">
        <div class="container2">
            <img src="/photos/photos_batHagil/garden.jpg" class="img-responsive" style="width:100%; height:60%" alt="Image">
                <div class="text-block">
                   <h5>הגן</h5>
                </div>
        </div>
      ...
      <div class="col-sm-4"> 
        <div class="container2">
      <img src="/photos/photos_batHagil/kitchen.jpg" class="img-responsive" style="width:100%; height:60%" alt="Image">
            <div class="text-block">
                <h5>האוכל</h5>    
            </div>
        </div>
    ...
    <div class="col-sm-4"> 
        <div class="container2">
             <img src="/photos/photos_batHagil/hall.jpg" class="img-responsive" style="width:100%; height:60%" alt="Image">
             <div class="text-block">
                <h5>האולם</h5>
            </div>
    </div> 
...
<div class="slideshow-container col-12">
    ...
    <div class="mySlides">
        <p>מקום קסום, משלב בין טבע שמיים ומים! צוות המקום מקבל, מפנק. הורידו לנו במחיר המנה והסכימו להתמקח העיקר שנצא מרוצים. התמורה ביחס למחיר גבוהה מאוד</p>
    <p class="author">- נועם רוז -</p>
    </div>

    <div class="mySlides">
        <p>התחתנו ב21.09.18 איך שנכנסו לגן ידענו שזה המקום שבו נתחתן, חולי המדהימה ליוותה אותנו לאורך כל הדרך, לא משנה כמה חפרנו לה היא תמיד הייתה שם להרגיע ולתת עצה טובה, באמת שאין לנו מושג איך היינו מסתדרים בלעדיה, דני וכל הצוות היו שם בשבילנו ועזרו לנו להגשים כל גחמה שהייתה לנו הכל היה מתוקתק בחתונה קיבלנו אינספור מחמאות על האוכל והשירות של המלצרים תודה רבה לכם שעל שעזרתם לנו להגשים ולממש את חתונת החלומות שלנו אוהבים מאיה ודניאל</p>
        <p class="author">- רוני כהן -</p>
    </div>

    <div class="mySlides">
        <p>אנחנו אנשי העמק מכפר יחזקאל והיה לנו ברור שאנחנו מתחתנים בעמק. ואין מקום יותר מושלם וקסום מבת הגלבוע. קיבלנו מהפגישה הראשונה עד האירוע ובאירוע יחס אישי ומיוחד</p>
        <p class="author">- גני ברוד  -</p>
    </div>
