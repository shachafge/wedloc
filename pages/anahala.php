...
<header class="col-12" id="upPage">
    ...
    <!--title of the place-->
    <div id="titlePlace"><p>הנחלה</p></div>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="/photos/photos_anahala/cover.jpg" alt="Image">
      </div>

      <div class="item">
        <img src="/photos/photos_anahala/cover2.jpg" alt="Image">
      </div>
      
      <div class="item">
        <img src="/photos/photos_anahala/cover3.jpg" alt="Image">
      </div>
    </div>
...
<div class="container text-center col-12">    
  <div class="row">
      ...
      <div class="well">
        ...
        $sql = "SELECT street, number, city FROM address WHERE idP=10";
        ...
        $sql2 = "SELECT email, phone, url FROM place WHERE idPlace=10";
      ...
      <div class="well">
      <p>הנחלה הייתה המקום בו אספנו רבים מזיכרונות ילדותינו, מקטיף תפוזים, איסוף פקאנים ורכיבה על סוסים. הבריכה בגלגולה הקודם הייתה בריכת השקיה בה למדנו לשחות.
בראש הגבעה הפעלנו במשך שנים בית ספר שיקומי-סביבתי לילדים בעלי צרכים מיוחדים, כיום פועלת במקום סדנת תעסוקה לבוגרי בית הספר שגדלו, חלק מהכנסות האירועים מהווה תרומה להפעלתה.
קסמה של הנחלה משך אליה לאורך השנים את חברינו שהגיעו לבלות בה איתנו, רבים מהם הביעו משאלה כי במקום קסום כזה היו רוצים להתחתן</p>
      </div>
       
    </div>
    <div class="col-sm-4">
        <div class="container2">
          <img src="/photos/photos_anahala/canopy.jpg" class="img-responsive" style="width:100%; height:60%" alt="Image">
    ...
    <div class="col-sm-4"> 
        <div class="container2">
            <img src="/photos/photos_anahala/garden.jpg" class="img-responsive" style="width:100%; height:60%" alt="Image">
            <div class="text-block">
                <h5>הגן</h5>
            </div>
        </div>
      ...
      <div class="col-sm-4">
          <div class="container2"> 
            <img src="/photos/photos_anahala/dance.jpg" class="img-responsive" style="width:100%; height:60%" alt="Image">
            <div class="text-block">
                <h5>הרחבה</h5>
            </div>
        </div>
    ...
    <div class="col-sm-4">
        <div class="container2">
            <img src="/photos/photos_anahala/hall.jpg" class="img-responsive" style="width:100%; height:60%" alt="Image">
                <div class="text-block">
                    <h5>האולם</h5>
                </div>
            </div>
...
<div class="slideshow-container col-12">
    ...
    <div class="mySlides">
    <p>היה אירוע מדהים, נהננו מכל שניה.. הצוות היה מעולה והאוכל</p>
    <p class="author">- עמית מורד -</p>
    </div>

    <div class="mySlides">
        <p>היה פשוט אדיר! ללא טיפת לחץ! אווירה מדהימה, אנשים נדירים ואוכל מטורף! מושלם, מושלם, מושלם!! תודה על הכל</p>
        <p class="author">- דניאלה קאופמן -</p>
    </div>

    <div class="mySlides">
        <p>אם אתם מעוניינים להשקיע באירוע ופרט באורחים שלכם, הנחלה הוא אחד המקומות המדהימים עבור זה</p>
        <p class="author">- לאורה לדרמן  -</p>
    </div>
