...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="/photos/photos_sheva/cover.jpg" alt="Image">
      </div>

      <div class="item">
        <img src="/photos/photos_sheva/cover2.jpg" alt="Image">
      </div>
      
      <div class="item">
        <img src="/photos/photos_sheva/cover3.jpg" alt="Image">
      </div>
    </div>
...
<div class="container text-center col-12">    
  <div class="row">
      ...
      <div class="well">
        ...
        $sql = "SELECT street, number, city FROM address WHERE idP=9";
        ...
        $sql2 = "SELECT email, phone, url FROM place WHERE idPlace=9";
      ...
      <div class="well">
          <p>קבלו 7 סיבות לעשות את הכל בשבע- אולם אירועים בתל אביב:
1. מיקום מרכזי – בלב של תל אביב וגם 2 דקות מהכניסה והיציאה לנתיבי איילון

2. חצר גדולה – משמשת לקבלת הפנים ולחופות ומרושתת בצמחיה פורחת כל עונות השנה

3. מערכות תאורה, הגברה וסאונד משוכללות – מאפשרות איכות ברמות אחרות

4. עומר מילר על האוכל – השף המפורסם, בעל קייטרינג "בזאר", אחראי למנות שלא תשכחו

5. בר הבית "ספירייט בר" – משקאות מהשורה הראשונה ומים לסיום האירוע לנסיעה טובה

6. חנייה בשפע – שלושה חניונים צמודים, לנוחות מרבית בקבלת הפנים

7. רישיון עסק בתוקף – יש והוא חשוב לנו ולכם</p>
      </div>
       
    </div>
    <div class="col-sm-4">
        <div class="container2">
            <img src="/photos/photos_sheva/canopy.jpg" class="img-responsive" style="width:100%; height:60%" alt="Image">
    ...
    <div class="col-sm-4">
        <div class="container2"> 
            <img src="/photos/photos_sheva/kitchen.jpg" class="img-responsive" style="width:100%; height:60%" alt="Image">
                <div class="text-block">
                    <h5>האוכל</h5>
                </div>
            </div>
      ...
      <div class="col-sm-4">
          <div class="container2"> 
            <img src="/photos/photos_sheva/dance.jpg" class="img-responsive" style="width:100%; height:60%" alt="Image">
                <div class="text-block">
                    <h5>הרחבה</h5>
                </div>
            </div>
    ...
    <div class="col-sm-4">
        <div class="container2"> 
            <img src="/photos/photos_sheva/hall.jpg" class="img-responsive" style="width:100%; height:60%" alt="Image">
                <div class="text-block">
                    <h5>האולם</h5>
                </div>
            </div>
...
<div class="slideshow-container col-12">
    ...
    <div class="mySlides">
        <p>הבחירה בשבע היא הבחירה המוצלחת ביותר בכל המובנים! שירות מעל לכל! שירות אדיב, מלצרים וברמנים מקצועיים ואיכותיים, אוכל מושלם ברמה הגבוהה ביותר( נתן מענה לכל אוכלי הבשר ואוכלי הצמחוני) רמת תחזוקה וניקיון גבוהה, צוות מנצח: לירן, שניר ורן - תודה על חוויה מושלמת ונעימה, אין ספק שאתם הדבר הכי טוב שיש</p>
    <p class="author">- סיון דני -</p>
    </div>

    <div class="mySlides">
        <p>הגענו לשבע אחרי לא מעט מקומות שראינו וכבר היינו די מבולבלים וחסרי כוחות. מאוד אהבנו את העיצוב של האולם והחצר ומאוד אהבנו את המיקום - ת"א, עם גישה נוחה מאיילון וחניה מסודרת בחוץ (אפשרות לקבלת מדבקות לאורחים). שישי צהריים הייתה האפשרות התקציבית היחידה מבחינתנו ומה שקנה אותנו זה שאפשר להחשיך את האולם, כך שהמסיבה הופכת להיות ממש מסיבה כמו בערב (לי זה היה מאוד חשוב). המקום דיבר אלינו גם בזכות השם הטוב שיש לקייטרינג של עומר מילר</p>
        <p class="author">- יעל בר זוהר -</p>
    </div>

    <div class="mySlides">
        <p>חווית שירות נפלאה, מרגע פגישת ההיכרות. סגרנו מול שרון, שהייתה מרעננת, מקצועית וכולה אנרגיות טובות! המנהל לירן בא לקראתנו באופן שמאוד הערכנו. הצוות כולו אדיב מאוד. דואגים להיות זמינים ולתת מענה לכל. האוכל מדהים.... עומר מילר. אין אורח שלא החמיא לנו על רמת התקתוק של האירוע</p>
        <p class="author">- נעמי סדור -</p>
    </div>
